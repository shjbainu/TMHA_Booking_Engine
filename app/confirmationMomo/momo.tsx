...
export default function MomoPaymentPopup({ isOpen, onClose, amount }: MomoPaymentPopupProps) {
  if (!isOpen) return null

  // The QR code image from your original screenshot
  const qrCodeImageUrl = "/images/momo-qr-code.png" // Updated path to public/images
      ...
      >
        ...
        <div className="p-5 pt-2">
          ...
          <div className="flex items-center mb-5">
            ...
            <h2 className="flex-grow text-center text-lg font-semibold text-gray-800 pr-10">THANH TOÁN BẰNG MOMO</h2>
          </div>
