...
import { ArrowLeft, ShieldCheck, CalendarRange, BedDouble, Check } from "lucide-react"
...
export default function Payment() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1542314831-068cd1dbb563?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
      }}
    >
      {/* Header */}
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-lg p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Input
                    ...
                    className="mt-1 h-12 bg-white/50"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="Để nhận xác nhận đặt phòng"
                ...
                <div className="space-y-4 text-sm">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 flex items-center gap-2">
                      <CalendarRange className="h-4 w-4" /> Ngày
                    </span>
                    <span className="font-medium">25/04 - 27/04/2025 (2 đêm)</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 flex items-center gap-2">
                      <BedDouble className="h-4 w-4" /> Phòng
                    </span>
