...
import { ArrowLeft, RotateCcw, Trash2, X, Lock } from "lucide-react" // Removed CreditCard as it wasn't used
...
function VisaMastercardPaymentPopup({ isOpen, onClose, amount }: VisaMastercardPaymentPopupProps) {
  ...
  const handleConfirmAndPay = async () => {
    // 1. Simulate payment processing (replace with actual API call)
    console.log("Attempting payment for:", amount);
    ...
    try {
      ...
      // Assuming your confirmation page is at the route /confirmation
      // and the file is app/confirmation/page.tsx (or .jsx)

    } catch (error) {
      // Handle payment failure (e.g., show an error message)
      console.error("Payment failed:", error);
      // Optionally, keep the popup open and display an error.
    }
  };
      ...
      >
        ...
        <div className="p-5 pt-2">
            ...
            <Button
              ...
              onClick={handleConfirmAndPay} // Updated onClick handler
            >
...
export default function Payment() {
  ...
  // Determine the amount for the popup.
  // The popup image shows "1.078.000đ".
  // The page total is "3.324.000đ".
  // You'll need to decide which amount is correct for the Visa/Mastercard payment.
  // For this example, I'll use the total amount from the page, assuming that's what's being paid.
  const totalAmountToPay = "3.324.000đ"; 
  // If you only want to pay for one booking (e.g. BOOKING 1: 1.078.000đ), change this value.
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="p-4">
        ...
        <div className="mb-6">
          ...
          {/* ... (Booking 1 and Booking 2 sections remain the same) ... */}
          {/* Booking 1 */}
        ...
        <div className="mb-6">
          ...
          {/* ... (Customer Information form remains the same) ... */}
          <div className="space-y-4">
            <div>
        ...
        <div className="mb-6">
          ...
          {/* ... (Payment Details section remains the same, including the total amount) ... */}
          <div className="space-y-4">
            {/* Booking 1 Details */}
            <div>
        ...
        <div className="mb-6">
          ...
          {/* ... (Payment Methods section remains the same) ... */}
        ...
        {/* Confirm Button - Opens the popup */}
        <Button
      ...
      <VisaMastercardPaymentPopup
        ...
        amount={totalAmountToPay} // Pass the dynamic total amount
      />
    </div>
  )
}
