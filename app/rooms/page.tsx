            ...
            {(() => {
              ...
              return (
                <div
                  ...
                  className="border border-gray-200/50 rounded-2xl p-5 bg-gradient-to-br from-blue-50 to-indigo-100 shadow-lg hover:shadow-xl transition-shadow duration-200 mb-4 opacity-20"
                >
