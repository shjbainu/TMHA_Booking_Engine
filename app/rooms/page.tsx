...
export default function RoomSelection() {
  ...
  // All handler functions (handleAddBooking, handleRoomExpand, etc.) remain unchanged
          ...
          <div key={booking.id}>
            ...
            {(() => {
              ...
              return (
                ...
                >
                   {/* Phần nội dung thẻ giữ nguyên như cũ, chỉ cần copy paste lại */}
                  <div className="grid grid-cols-5 gap-2 mb-4">
                    <div className="col-span-3 relative aspect-[3/4] rounded-xl overflow-hidden shadow-md">
                      <ImageComponent
                    ...
                    <div className="col-span-2 grid grid-rows-2 gap-2">
                      ...
                      <div className="relative aspect-square rounded-xl overflow-hidden shadow-md flex items-center justify-center">
                        <ImageComponent
