          ...
          <div key={booking.id}>
            ...
            {(() => {
              ...
              return (
                <div
                  ...
                  className="border border-gray-200/50 rounded-2xl p-5 bg-gradient-to-br from-blue-50 to-indigo-100 shadow-lg hover:shadow-xl transition-shadow duration-200 mb-4 bg-opacity-20"
                >
            ...
            {(() => {
              ...
              return (
                <div
                  key={`${booking.id}-${room.id}`}
                  className="border border-gray-200/50 rounded-2xl p-5 bg-gradient-to-br from-green-50 to-teal-100 shadow-lg hover:shadow-xl transition-shadow duration-200 mb-4 bg-opacity-60"
                >
                  <div className="grid grid-cols-5 gap-2 mb-4 rounded-2xl bg-gray-50/30">
                    <div className="col-span-3 relative aspect-[3/4] rounded-xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 shadow-sm">
                      <ImageComponent
            ...
            {(() => {
              ...
              return (
                <div
                  key={`${booking.id}-${room.id}`}
                  className="border border-gray-200/50 rounded-2xl p-5 bg-gradient-to-br from-purple-50 to-pink-100 shadow-lg hover:shadow-xl transition-shadow duration-200 mb-4 bg-opacity-60"
                >
                  <div className="grid grid-cols-5 gap-2 mb-4 rounded-2xl bg-gray-50/30">
                    ...
                    <div className="col-span-3 relative aspect-[3/4] rounded-xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 shadow-sm">
                      <ImageComponent
                        ...
                        alt={room.id === "3" ? "Phòng Mập Mờ main image" : "Phòng Santorini main image"}
                        fill
                        className="object-cover"
                        sizes="(max-width: 768px) 60vw, 300px"
                      />
                    ...
                    <div className="col-span-2 grid grid-rows-2 gap-2">
                      <div className="relative aspect-square rounded-xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 shadow-sm">
                        <ImageComponent
                          ...
                          alt={room.id === "3" ? "Phòng Mập Mờ secondary image 1" : "Phòng Santorini secondary image 1"}
                          fill
                          className="object-cover"
                          sizes="(max-width: 768px) 40vw, 200px"
                        />
                      ...
                      <div className="relative aspect-square rounded-xl overflow-hidden bg-gradient-to-br from-gray-300 to-gray-400 shadow-sm flex items-center justify-center">
                        <ImageComponent
                          ...
                          alt={room.id === "3" ? "Phòng Mập Mờ secondary image 2" : "Phòng Santorini secondary image 2"}
                          fill
                          className="object-cover"
                          sizes="(max-width: 768px) 40vw, 200px"
                        />
                  ...
                  <h3 className="text-lg font-semibold text-[#0a0a0a] mb-2">
                    {room.id === "3" ? "Phòng Mập Mờ" : "Phòng Santorini"}
                  </h3>
            ...
            {(() => {
              ...
              return (
                <div
                  key={`${booking.id}-${room.id}`}
                  className="border border-gray-200/50 rounded-2xl p-5 bg-gradient-to-br from-yellow-50 to-orange-100 shadow-lg hover:shadow-xl transition-shadow duration-200 mb-4 bg-opacity-60"
                >
                  <div className="grid grid-cols-5 gap-2 mb-4 rounded-2xl bg-gray-50/30">
                    {/* Large image on the left */}
                    <div className="col-span-3 relative aspect-[3/4] rounded-xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 shadow-sm">
