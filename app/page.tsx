    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center justify-between p-4 bg-white sticky top-0 z-10 border-b border-gray-200">
        ...
        <div className="flex items-center">
          <Button variant="ghost" size="icon" className="h-10 w-10">
            <Image src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fpikbest.com%2Fpng-images%2Fshare-button-icon-3d-illustration_10427096.html&psig=AOvVaw2s9c1TiKgOmjuQ3cvUFkgM&ust=1749182303249000&source=images&cd=vfe&opi=89978449&ved=0CBUQjRxqFwoTCKiY85Oy2Y0DFQAAAAAdAAAAABAE" width={30} height={30} className="mb-0.5" />
          </Button>
          <Button variant="ghost" size="icon" className="h-10 w-10">
