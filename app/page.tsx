    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center justify-between p-4 bg-white sticky top-0 z-10 border-b border-gray-200">
        ...
        <div className="flex items-center">
          <Button variant="ghost" size="icon" className="h-10 w-10">
            <Image src="https://www.iconfinder.com/icons/4141636/hotel_love_making_motel_romantic_sex_icon" width={30} height={30} className="mb-0.5" />
          </Button>
          <Button variant="ghost" size="icon" className="h-10 w-10">
           <Image src="https://drive.google.com/file/d/1ONLMYglA_sm_pYeIwRfxrDeZV3RiuySV/view?usp=sharing" alt="Hotel Icon" width={35} height={35} className="mb-0.5" />
          </Button>
          <Button variant="ghost" size="icon" className="h-10 w-10">
        ...
        <div className="w-full max-w-md">
          ...
          {/* Button Tổng quan */}
            ...
            <Button
              ...
              className="h-auto flex flex-col items-center justify-center px-2 py-1.5 text-[#0a0a0a] hover:bg-gray-100 focus:bg-gray-100"
            >
              <Image src="data:image/png;base64," alt="Hotel Icon" width={40} height={40} className="mb-0.5" />
            </Button>
