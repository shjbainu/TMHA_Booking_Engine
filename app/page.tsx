      ...
      <div className="fixed bottom-0 left-0 right-0 flex justify-center bg-white z-20 border-t border-gray-200">
        <div className="w-full max-w-md">
          <div className="flex items-center justify-around px-1 py-1.5">
            ...
            >
              <Image src="https://png.pngtree.com/png-clipart/20231020/original/pngtree-hotel-illustration-3d-png-image_13379998.png" alt="Hotel Icon" width={24} height={24} className="mb-0.5" />
