      ...
      <div className="fixed bottom-0 left-0 right-0 flex justify-center bg-white z-20 border-t border-gray-200">
        <div className="w-full max-w-md">
          <div className="flex items-center justify-around px-1 py-1.5">
            <Link
              href="https://www.google.com/maps/place/69+Boutique+by+Minova/@21.0098484,105.8081949,17z/data=!4m9!3m8!1s0x3135ab021e83f8ef:0x680ada8abe8093a1!5m2!4m1!1i2!8m2!3d21.0098434!4d105.8107698!16s%2Fg%2F11h9k2scz4?entry=ttu&g_ep=EgoyMDI1MDYwMi4wIKXMDSoASAFQAw%3D%3D"
              passHref
              legacyBehavior
            >
              <a target="_blank" rel="noopener noreferrer">
                ...
                >
                  <Image
                    src="/public/images/hotel-icon.png"
                    alt="Hotel Icon"
                    width={40}
                    height={40}
                    className="mb-0.5"
