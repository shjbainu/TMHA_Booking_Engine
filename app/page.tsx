    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center justify-between p-4 bg-white sticky top-0 z-10 border-b border-gray-200">
        ...
        <div className="flex items-center">
          ...
          <Button variant="ghost" size="icon" className="h-10 w-10">
            <Image src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQcI8mNNdSx6WntKdxjwKqmAwl-PwyUJsRLOyZ7awAm1mfL27Qi" alt="Hotel Icon" width={30} height={30} className="mb-0.5" />
          </Button>
        </div>
      </div>
